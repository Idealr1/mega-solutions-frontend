    ...
    return (
        <div className="contact-page">
                    ...
                    <div className="info-item">
                        ...
                        <div className="info-text">
                            ...
                            <p className="info-value highlight">
                                2040 Steel Dr, Suite A, E &amp; D <br /> Tucker, GA 30084
                            </p>
                        </div>
                    </div>
            ...
            <div className="contact-map-section">
                <iframe
                    src="https://www.google.com/maps?q=2040+Steel+Dr+Suite+A+Tucker+GA+30084&output=embed"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
                    ...
                    title="TK Stone and Cabinets — Tucker, GA office"
