    ...
    return (
        <div className="visualizer-container">
            ...
            <div className="canvas-wrapper">
                ...
                {/* ─── WALL SELECTION CONFIRMATION PANEL ───────────────────────── */}
                {pendingWallId && (() => {
                    const wall = surfaces.find(s => s.id === pendingWallId);
                    if (!wall) return null;
                    const orientLabel = wall.orientation === 'left' ? '← Left Wall'
                        : wall.orientation === 'right' ? 'Right Wall →'
                            : wall.type === 'floor' ? 'Floor'
                                : 'Back Wall';
                    return (
                        <div className="wall-confirm-panel">
                            <div className="wall-confirm-icon">🏠</div>
                            <div className="wall-confirm-info">
                                <strong>{orientLabel}</strong>
                                <span>selected — ready to fill with cabinets</span>
                            </div>
                ...
                {fillToast && (
                    <div className="fill-toast">
                        <span className="fill-toast-icon">✓</span>
